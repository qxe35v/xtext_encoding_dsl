...
public class InternalEncodingLangLexer extends Lexer {
    ...
    public final void mRULE_INPUTCHAR() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalEncodingLang.g:736:16: ( '0x' ( ( '0' .. '9' | 'a' .. 'f' ) ( '0' .. '9' | 'a' .. 'f' ) )+ )
            // InternalEncodingLang.g:736:18: '0x' ( ( '0' .. '9' | 'a' .. 'f' ) ( '0' .. '9' | 'a' .. 'f' ) )+
            {
            match("0x"); 

            // InternalEncodingLang.g:736:23: ( ( '0' .. '9' | 'a' .. 'f' ) ( '0' .. '9' | 'a' .. 'f' ) )+
            int cnt1=0;
            loop1:
            do {
                int alt1=2;
                ...
                switch (alt1) {
            	case 1 :
            	    // InternalEncodingLang.g:736:24: ( '0' .. '9' | 'a' .. 'f' ) ( '0' .. '9' | 'a' .. 'f' )
            	    {
